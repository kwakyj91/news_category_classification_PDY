...
df = pd.read_csv('./data/project_news_titles.csv')
df.info()
print(df.head(30))
...
print(label)
with open('./data/encoder_0608.pkl', 'wb') as f:
    pickle.dump(label, f)
onehot_y = to_categorical(labeled_y)
print(onehot_y[:5])

# cleaned_x = re.sub('[^가-힣]',' ',X)
# print(X[0])
# print(cleaned_x)
...
with open('./data/tokenizer_0608_mac{}.pkl'.format(max), 'wb') as f:
